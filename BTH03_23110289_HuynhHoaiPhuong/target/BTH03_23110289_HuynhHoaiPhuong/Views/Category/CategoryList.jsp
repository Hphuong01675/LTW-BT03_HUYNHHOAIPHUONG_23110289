...
<!-- Nút quay về Manager Home nếu là manager -->
<c:if test="${currentUser.roleid == 1}">
    <a href="${pageContext.request.contextPath}/manager/home" class="btn btn-warning mb-3">
        ⬅ Quay về Manager Home
    </a>
</c:if>
    ...
    <tbody>
        <c:forEach var="c" items="${categories}">
            <tr>
                ...
                <td>
                    <!-- Chỉ hiện nút Sửa/Xóa nếu thuộc về chính user -->
